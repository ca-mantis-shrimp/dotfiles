...
local function _1_()
  ...
  servers = {lua_ls = {settings = {Lua = {completion = {callSnippet = "Replace"}, diagnostics = {globals = {"vim"}}}}}, fennel_ls = {}, ruff = {init_options = {settings = {}}}, sqls = {settings = {connections = {{alias = "test db", driver = "sqlite3", dataSourceName = "file:test.db?cache=shared&mode=memory"}}}, on_attach = _2_}, rust_analyzer = {diagnostics = {enable = true}}}

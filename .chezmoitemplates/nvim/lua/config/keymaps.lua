...
do
  ...
  wk.add({{"<leader>c", group = "[C]ode"}, {"<leader>d", group = "[D]ocument"}, {"<leader>h", group = "Git [H]unk"}, {"<leader>r", group = "[R]ename"}, {"<leader>s", group = "[S]earch"}, {"<leader>t", group = "[T]oggle"}, {"<leader>w", group = "[W]orkspace"}, {"<leader>n", group = "[N]eorg"}, {"<leader>l", group = "[L]ists in Neorg"}, {"<leader>h", desc = "Git [H]unk", mode = "v"}})
end
...
_G.vim.keymap.set("n", "<leader>uc", "<cmd>CodeCompanionChat Toggle<CR>", {desc = "[u]i to toggle code completion [c]hat"})
return _G.vim.keymap.set("n", "<leader>sA", "<cmd>CodeCompanionActions<CR>", {desc = "[s]earch CodeCompanion [a]ctions"})

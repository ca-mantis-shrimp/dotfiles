-- [nfnl] plugins/platforms/snacks.fnl
local function _1_()
...
return {
	...
	keys = {
		...
		{ "<leader>,", _2_, desc = "Search Buffers" },
		{ "<leader>/", _3_, desc = "Grep Files" },
		{ "<leader>:", _4_, desc = "Search Command History" },
		{ "<leader>N", _5_, desc = "Search Notifications" },
		{ "<leader>e", _6_, desc = "Open File Explorer" },
		{ '<leader>"', _7_, desc = "Search Registers" },
		{ "<leader>sh", _8_, desc = "Search Help Docs" },
		{ "<leader>sm", _9_, desc = "Search Marks" },
		{ "<leader>sM", _10_, desc = "Search Man Pages" },
		{ "<leader>sk", _11_, desc = "Search Keymaps" },
		{ "<leader>sp", _12_, desc = "Search Projects" },

...
local interactions_config =
	{ chat = { adapter = "anthropic" }, inline = { adapter = "anthropic" }, cmd = { adapter = "anthropic" } }
local mcphub_config = {
...
local extensions_config = { mcphub = mcphub_config, vectorcode = vectorcode_config }
...
adapters_config = { acp = { claude_code = _1_ } }
local memory_config = { opts = { chat = { enabled = true } } }
...
return { { "github/copilot.vim" }, codecompanion_spec, sidekick_spec }

...
return {"nvim-treesitter/nvim-treesitter", build = ":TSUpdate", dependencies = {{"ClearHeadToDo-Devs/tree-sitter-actions", dev = true}}, opts = {ensure_installed = {"bash", "c", "html", "lua", "luadoc", "markdown", "vim", "vimdoc", "python"}, auto_install = true, highlight = {enable = true}, indent = {enable = true}, incremental_selection = {enable = true, keymaps = {init_selection = "gsi", node_incremental = "gsn", scope_incremental = "gss", node_decremental = "gsd"}}}, config = _1_}
